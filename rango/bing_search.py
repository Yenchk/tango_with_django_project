...
def read_bing_key():
    ...
    remember to put bing.key in your .gitigonre file to avoid committing it.

    See Python Anti-Patterns - it is an awesome resource to imporve your python code
...
def run_query(search_terms):
    """
    See the Microsoft's documnetation on other parameters that you can set.
    ...
    # With the response now in play, bulid up a Python list.
    results = []
